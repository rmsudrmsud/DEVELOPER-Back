...
public class RoomReviewService {
	...
	private final RoomReviewRepository rrRepository;
	private final ReservationRepository rRepository;

	/**
	 * 포스트맨 성공 [마이페이지 스터디카페 후기페이지] 후기작성한다
	 * 
	 * @author ds
	...
	/**
	 * 포스트맨 성공 [마이페이지 스터디카페 후기페이지]특정 스터디룸 후기 리스트 전체출력
	 * 
	 * @author ds
	...
	/**
	 * 포스트맨 성공 [마이페이지 스터디카페 후기페이지] 유저 아이디로 작성한 이용후기 목록을 출력한다
	 * 
	 * @author ds
	 * @param userId 유저아이디
