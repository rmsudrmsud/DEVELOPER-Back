...
public class OrdersController {
	 ...
	 */
	@PostMapping(value = "payment/add/{lessonSeq}", produces = {"application/json; charset=UTF-8",MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<?> addOrders(@RequestBody Map<String, Object> result ,HttpSession session, @PathVariable Long lessonSeq
//			,Model model
